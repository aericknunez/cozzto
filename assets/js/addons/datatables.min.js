! function(e) {
        ...
        if (a)
            for (l = a.length - 1; l >= 0; l--) {
                ...
                for (e.isArray(p) || (p = [p]), s = 0, u = p.length; u > s; s++)
                    ...
                    for (f = 0, c = h.length; c > f; f++)("_all" == p[s] || e(h[f].nTh).hasClass(p[s])) && i(f, d)
            }
        if (n)
            ...
            if ("" !== i)
                for (var f = K(i), c = 0, d = f.length; d > c; c++) {
                    if (l = f[c].match(Z), o = f[c].match(Q), l) {
                        if (f[c] = f[c].replace(Z, ""), "" !== f[c] && (t = t[f[c]]), s = [], f.splice(0, c + 1), u = f.join("."), e.isArray(t))
        ...
        var a = function(t, n, i) {
            for (var o, u, f, c, d, l = K(i), s = l[l.length - 1], h = 0, p = l.length - 1; p > h; h++) {
                if (u = l[h].match(Z), f = l[h].match(Q), u) {
                    if (l[h] = l[h].replace(Z, ""), t[l[h]] = [], o = l.slice(), o.splice(0, h + 1), d = o.join("."), e.isArray(n))
                        for (var v = 0, g = n.length; g > v; v++) c = {}, a(c, n[v], d), t[l[h]].push(c);
                    else t[l[h]] = n;
                    return
                }
    ...
    function ne(e, t, a) {
        for (var n = -1, i = 0, l = e.length; l > i; i++) e[i] == t ? n = i : e[i] > t && e[i]--; - 1 != n && a === r && e.splice(n, 1)
    }
    ...
    function le(t, a, n, i) {
        ...
        if (o)
            for (; o;) s = o.nodeName.toUpperCase(), ("TD" == s || "TH" == s) && (g(o), l.push(o)), o = o.nextSibling;
        else {
            l = a.anCells;
    ...
    function ce(t) {
        ...
        if (0 !== v.length)
            for (var m = p ? 0 : g, S = p ? t.aoData.length : b, D = m; S > D; D++) {
                ...
                1 == t.iDraw && "ajax" == mt(t) ? C = d.sLoadingRecords : d.sEmptyTable && 0 === t.fnRecordsTotal() && (C = d.sEmptyTable), o[0] = e("<tr/>", {
                    "class": f ? u[0] : ""
                }).append(e("<td />", {
                    valign: "top",
                    colSpan: E(t),
        ...
        for (l = 0, u = r.length; u > l; l++)
            for (n = r[l], d = 0, i = n.firstChild; i;) {
                if ("TD" == i.nodeName.toUpperCase() || "TH" == i.nodeName.toUpperCase())
                    for (h = 1 * i.getAttribute("colspan"), p = 1 * i.getAttribute("rowspan"), h = h && 0 !== h && 1 !== h ? h : 1, p = p && 0 !== p && 1 !== p ? p : 1, c = g(t, l, d), v = 1 === h ? !0 : !1, s = 0; h > s; s++)
    ...
    function ve(e, t, a) {
        ...
        for (var n = 0, i = a.length; i > n; n++)
            for (var l = 0, o = a[n].length; o > l; l++) !a[n][l].unique || r[l] && e.bSortCellsTop || (r[l] = a[n][l].cell);
        return r
    }
    ...
    function ge(t, a, r) {
        ...
        var c = {
            ...
            error: function(a, r, n) {
                var i = vt(t, null, "xhr", [t, null, t.jqXHR]); - 1 === e.inArray(!0, i) && ("parsererror" == r ? ft(t, 0, "Invalid JSON response", 1) : 4 === a.readyState && ft(t, 0, "Ajax error", 7)), Ve(t, !1)
            }
        };
        ...
        }), u, t) : t.sAjaxSource || "string" == typeof o ? t.jqXHR = e.ajax(e.extend(c, {
            url: o || t.sAjaxSource
        })) : "function" == typeof o ? t.jqXHR = o.call(s, a, u, t) : (t.jqXHR = e.ajax(e.extend(c, o)), o.data = l)
    }
    ...
    function Ce(e, t, a, r, i, l) {
        var f, c, d, o = xe(t, r, i, l),
            ...
            u = e.aiDisplayMaster,
            h = [];
        if (0 !== n.ext.search.length && (a = !0), c = Le(e), t.length <= 0) e.aiDisplay = u.slice();
        else {
    ...
    function Xe(t) {
        ...
        var p = e(d, {
            ...
            width: r.sXInner || "100%"
        }).append(u.removeAttr("id").css("margin-left", 0).append("top" === s ? o : null).append(a.children("thead"))))).append(e(d, {
            "class": l.sScrollBody
        }).css({
            position: "relative",
            overflow: "auto",
        ...
        }).append(f.removeAttr("id").css("margin-left", 0).append("bottom" === s ? o : null).append(a.children("tfoot")))));
        var v = p.children(),
            g = v[0],
            b = v[1],
            m = c ? v[2] : null;
    ...
    function $e(a) {
        ...
        if (y || !p && !o && !l && u == E(a) && u == c.length)
            for (v = 0; u > v; v++) {
                ...
                if (a.aoData.length)
                    for (v = 0; v < f.length; v++) b = f[v], g = n[b], e(Ze(a, b)).clone(!1).append(g.sContentPadding).appendTo(C);
    ...
    function et(t) {
        ...
        for (e.isArray(v) && m(v), g && v.pre && m(v.pre), m(t.aaSorting), g && v.post && m(v.post), a = 0; a < b.length; a++)
            for (p = b[a][0], c = f[p].aDataSort, l = 0, o = c.length; o > l; l++) d = c[l], h = f[d].sType || "string", b[a]._idx === r && (b[a]._idx = e.inArray(b[a][1], f[d].asSorting)), s.push({
                src: p,
                col: d,
                dir: b[a][1],
                index: b[a]._idx,
        ...
        if ("ssp" != mt(e) && 0 !== w.length) {
            ...
            D === w.length ? _.sort(function(e, t) {
                var a, r, n, i, l, o = w.length,
                    ...
                    u = h[t]._aSortData;
                for (n = 0; o > n; n++)
                    if (l = w[n], a = s[l.col], r = u[l.col], i = r > a ? -1 : a > r ? 1 : 0, 0 !== i) return "asc" === l.dir ? i : -i;
                ...
                var a, r, n, l, o, s, u = w.length,
                    ...
                    p = h[t]._aSortData;
                for (n = 0; u > n; n++)
                    if (o = w[n], a = f[o.col], r = p[o.col], s = d[o.type + "-" + o.dir] || d["string-" + o.dir], l = s(a, r), 0 !== l) return l;
                return a = c[e], r = c[t], r > a ? -1 : a > r ? 1 : 0
            })
        }
        e.bSorted = !0
    ...
    function rt(t, a, n, i) {
        ...
        if ("number" == typeof o[0] && (o = t.aaSorting = [o]), n && t.oFeatures.bSortMulti) {
            var c = e.inArray(a, y(o, "0")); - 1 !== c ? (u = f(o[c], !0), null === u && 1 === o.length && (u = 0), null === u ? o.splice(c, 1) : (o[c][1] = s[u], o[c]._idx = u)) : (o.push([a, s[0], 0]), o[o.length - 1]._idx = 0)
        ...
        var i, l, o = t.aoColumns,
            s = function(a) {
                ...
                if (t.oLoadedState = e.extend(!0, {}, a), a.start !== r && (t._iDisplayStart = a.start, t.iInitDisplayStart = a.start), a.length !== r && (t._iDisplayLength = a.length), a.order !== r && (t.aaSorting = [], e.each(a.order, function(e, a) {
                    ...
                    })), a.search !== r && e.extend(t.oPreviousSearch, Re(a.search)), a.columns)
    ...
    function ft(e, a, r, i) {
        if (r = "DataTables warning: " + (e ? "table id=" + e.sTableId + " - " : "") + r, i && (r += ". For more information about this error, please see http://datatables.net/tn/" + i), a) t.console && console.log && console.log(r);
        else {
            var l = n.ext,
    ...
    var i, l, o, s, n = function(t) {
            ...
            return this.each(function() {
                ...
                var I = w.asStripeClasses,
                    A = m.children("tbody").find("tr").eq(0); - 1 !== e.inArray(!0, e.map(I, function(e, t) {
                    return A.hasClass(e)
                })) && (e("tbody tr", this).removeClass(I.join(" ")), w.asDestroyStripes = I.slice());
                var H, P = [],
                    M = this.getElementsByTagName("thead");
                if (0 !== M.length && (pe(w.aoHeader, M[0]), P = ve(w)), null === l.aoColumns)
                ...
                var B = w.oFeatures,
                    E = function() {
                        ...
                        if (0 === o.length && a.length > 0 && ("" !== w.oScroll.sX || "" !== w.oScroll.sY) && (o = e("<tfoot/>").appendTo(m)), 0 === o.length || 0 === o.children().length ? m.addClass(T.sNoFooter) : o.length > 0 && (w.nTFoot = o[0], pe(w.aoFooter, w.nTFoot)), l.aaData)
                            for (u = 0; u < l.aaData.length; u++) J(w, l.aaData[u]);
                        else(w.bDeferLoading || "dom" == mt(w)) && q(w, e(w.nTBody).children("tr"));
    ...
    l = function(t, a) {
        ...
        filter: function(e) {
            ...
            if (Dt.filter) t = Dt.filter.call(this, e, this);
                ...
                for (var a = 0, r = this.length; r > a; a++) e.call(this, this[a], a, this) && t.push(this[a]);
        ...
        iterator: function(e, t, a, n) {
            ...
            for ("string" == typeof e && (n = a, a = t, t = e, e = !1), s = 0, u = d.length; u > s; s++) {
                ...
                else if ("columns" === t || "rows" === t) o = a.call(b, d[s], this[s], s), o !== r && i.push(o);
                else if ("column" === t || "column-rows" === t || "row" === t || "cell" === t)
                    for (p = this[s], "column-rows" === t && (h = It(d[s], g.opts)), f = 0, c = p.length; c > f; f++) v = p[f], o = "cell" === t ? a.call(b, d[s], v.row, v.column, s, f) : a.call(b, d[s], v, s, f, h), o !== r && i.push(o)
            }
            if (i.length || n) {
        ...
        map: function(e) {
            ...
            if (Dt.map) t = Dt.map.call(this, e, this);
                ...
                for (var a = 0, r = this.length; r > a; a++) t.push(e.call(this, this[a], a));
            return new l(this.context, t)
        },
        pluck: function(e) {
    ...
    var Tt = function(t, a, n, l, o) {
            var u, f, c, d, h, p, s = [],
                v = typeof a;
            for (a && "string" !== v && "function" !== v && a.length !== r || (a = [a]), c = 0, d = a.length; d > c; c++)
                for (f = a[c] && a[c].split && !a[c].match(/[\[\(:]/) ? a[c].split(",") : [a[c]], h = 0, p = f.length; p > h; h++) u = n("string" == typeof f[h] ? e.trim(f[h]) : f[h]), u && u.length && (s = s.concat(u));
            var g = i.selector[t];
            if (g.length)
        ...
        It = function(t, a) {
            ...
            if ("current" == c)
                ...
                for (r = 0, n = t.aoData.length; n > r; r++) "none" == u ? l.push(r) : (i = e.inArray(r, o), (-1 === i && "removed" == u || i >= 0 && "applied" == u) && l.push(r));
            return l
        },
        At = function(t, a, n) {
            var i, l = function(a) {
    ...
    o("rows()", function(t, a) {
        ...
        return this.iterator("row", function(t, a, n) {
            ...
            for (i.splice(a, 1), o = 0, s = i.length; s > o; o++)
                if (c = i[o], d = c.anCells, null !== c.nTr && (c.nTr._DT_RowIndex = o), null !== d)
    ...
    var Ft = function(t, a, r, n) {
        ...
        Rt = function(e) {
            ...
            t.off(r + " " + n + " " + i), y(o, "_details").length > 0 && (t.on(r, function(a, r) {
                ...
                if (e === a)
                    for (var i, l = E(a), s = 0, u = o.length; u > s; s++) i = o[s], i._details && i._details.children("td[colspan]").attr("colspan", l)
            }), t.on(i, function(a, r) {
                if (e === r)
    ...
    o("cells()", function(t, a, n) {
        ...
        for (var r, i, t = n.version.split("."), a = e.split("."), l = 0, o = a.length; o > l; l++)
            if (r = parseInt(t[l], 10) || 0, i = parseInt(a[l], 10) || 0, r !== i) return r > i;
        return !0
        ...
        oLanguage: {
            ...
            sInfoFiltered: "(Filtrado de _MAX_ total total de entradas)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
